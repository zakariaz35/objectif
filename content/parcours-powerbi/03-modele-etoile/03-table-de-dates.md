...
Le résultat doit être **0**. Une valeur **négative** signale des dates manquantes dans la table (moins de lignes que de jours dans la plage). Une valeur **positive** signale des doublons ou des lignes en trop.
