...
## Exemple chiffré : trois mois de CA

Avec un CA janvier/février/mars fictif, voici ce que renvoient `Sales MoM %` et `Sales YTD` mois par mois :

| Mois | `Total Sales` | `Sales MoM %` | `Sales YTD` |
|---|---|---|---|
| Janvier | 100 000 € | — (pas de mois précédent) | 100 000 € |
| Février | 108 000 € | `(108 000 − 100 000) / 100 000` = **+8 %** | `100 000 + 108 000` = **208 000 €** |
| Mars | 97 200 € | `(97 200 − 108 000) / 108 000` = **−10 %** | `208 000 + 97 200` = **305 200 €** |

Chaque `Sales MoM %` compare uniquement au mois précédent (rien à voir avec le cumul), tandis que `Sales YTD` additionne tous les mois depuis janvier — les deux mesures répondent à des questions différentes et se lisent côte à côte dans un même tableau.
