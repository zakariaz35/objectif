...
| Contexte du visuel | `[Total Sales]` renvoie |
|---|---|
| Carte seule (aucun filtre) | 261 000 € (le total global) |
| Ligne « Electronics » d'un tableau par `category` | 120 000 € |
| Ligne « Furniture » du même tableau | 78 000 € |

Une seule formule, aucune duplication — c'est le contexte de filtre (module suivant) qui fait varier le résultat.
