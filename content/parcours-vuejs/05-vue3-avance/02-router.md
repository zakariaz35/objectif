...
const routes = [
  { path: '/', component: Home },
  { path: '/invoices/:id', component: Invoice },   // :id = dynamic parameter
]
...
```vue
<RouterLink to="/invoices/42">Voir</RouterLink>   <!-- declarative -->
```
...
router.push('/invoices/42')          // programmatic navigation

const route = useRoute()
route.params.id                       // '42' — read the URL parameter
```
