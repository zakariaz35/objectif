/**
 * from-source-web.mjs — Convertit les cours (objets JS) de `source-web` vers l'arbre
 ...
 *
 * Usage : node content/_tools/from-source-web.mjs
 * Idempotent : réécrit les dossiers de formation ciblés.
 */
import { mkdirSync, rmSync, writeFileSync } from 'node:fs'
import { join } from 'node:path'

const SRC = '/path/to/source-web/src/data/courses'
...
const JOBS = [
  ...
  },
  {
    ...
    // Pydantic v2 (seul module projet source abouti) greffé en module d'intro : la
    // validation est le cœur de FastAPI (LookupInput + Depends + 422 auto).
    graft: [{ file: 'source.js', moduleId: 'm01-pydantic', slug: 'pydantic-validation' }],
  },
]
