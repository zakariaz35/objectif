...
Le principe du group-by, en une image : chaque **ligne** rejoint un **groupe** (ici le
mois), puis chaque groupe est réduit à un **total** :

```mermaid
flowchart LR
    subgraph Lignes["Lignes de commande"]
        L1["1001 · Jan"]
        L2["1002 · Jan"]
        L3["1003 · Fév"]
        L4["1004 · Fév"]
    ...
    subgraph Groupes["Group by mois"]
        GJan[Jan]
        GFev[Fév]
        GMar[Mar]
    end
    subgraph Totaux["Totaux"]
        TJan["85 €"]
        TFev["55 €"]
        TMar["120 €"]
    end
