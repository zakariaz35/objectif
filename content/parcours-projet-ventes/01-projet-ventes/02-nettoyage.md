...
## La version métier : pandas (repliée)
...
Voici les lignes concernées, brutes puis nettoyées :

**Avant (brut)**

| order_id | order_date | region | discount |
|---|---|---|---|
| 1002 | **18/01/2024** | South | 0.10 |
| 1003 | 2024-02-02 | **north** | 0 |
| 1005 | **2024/3/11** | South | 0 |
| 1006 | 2024-03-29 | West | 0.20 |
| **1006** | **2024-03-29** | **West** | **0.20** |
| 1007 | 2024-03-30 | East | **(vide)** |

**Après (propre)**

| order_id | order_date | region | discount |
|---|---|---|---|
| 1002 | 2024-01-18 | South | 0.10 |
| 1003 | 2024-02-02 | North | 0 |
| 1005 | 2024-03-11 | South | 0 |
| 1006 | 2024-03-29 | West | 0.20 |
| 1007 | 2024-03-30 | East | 0 |

Le doublon `1006` disparaît, `north` devient `North`, les dates passent en ISO, et le
`discount` vide devient `0` — rappel : c'est ce doublon qui gonflait le CA de **80 €**
(soit **+31 %** de CA fictif) avant nettoyage.
