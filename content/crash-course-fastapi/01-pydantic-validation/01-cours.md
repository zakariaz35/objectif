...
class LookupInput(BaseModel):
    """Look up a company by identifier. SIREN (9) or SIRET (14), mutually exclusive."""

    model_config = ConfigDict(extra="forbid")

    siren: str | None = Field(default=None, description="SIREN number (9 digits)")
    siret: str | None = Field(default=None, description="SIRET number (14 digits)")
...
class LookupInput(BaseModel):
    """SIREN (9) or SIRET (14), exactly one of the two — mirrors src/company/schemas.py."""
...
# Edit these payloads and re-run to see Pydantic in action:
essai("valid SIREN", siren="732829320")
essai("valid SIRET", siret="73282932000074")
essai("both (XOR violated)", siren="732829320", siret="73282932000074")
essai("none (XOR violated)")
essai("non-numeric", siren="ABC123XYZ")
essai("wrong length", siren="123")
essai("unknown field (extra=forbid)", siren="732829320", foo="bar")
```
