...
| --- | --- | --- |
| **Entity** | Objet avec une **identité** qui persiste dans le temps, même si ses attributs changent. | Une `Invoice` (identifiée par son id). |
...
| **Domain Event** | Fait métier **passé** qui intéresse le reste du système. | `ClosedInvoice`. |
