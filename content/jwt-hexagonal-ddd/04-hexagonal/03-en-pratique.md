...
> ```
>
> Pour les tests, tu bind un `InMemoryInvoiceRepository` (un simple tableau PHP). Le **service métier ne change pas d'une ligne** et tu testes sans DB. C'est tout le bénéfice.
