...
exercise:
  language: js
  starter: |
    // We classify a SALE into a category based on its amount (in euros):
    //   - montant >= 1000          -> "Grand compte"
    //   - montant >= 500           -> "Standard"
    //   - montant >  0             -> "Petit panier"
    //   - montant === 0 (or less)  -> "Aucune vente"
    // Returns the category as a string.
    function categorieVente(montant) {
      // TODO: chain tests from most restrictive to least (if / else if / else)
      return null
    }
