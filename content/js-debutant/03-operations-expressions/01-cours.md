...
console.log(7 / 3)    // 2.333...  division (always decimal in JS!)
console.log(7 % 3)    // 1    modulo: the REMAINDER of integer division
console.log(2 ** 10)  // 1024 exponentiation: 2 to the power of 10
```
...
```js
console.log(2 + 3 * 4)     // 14  (* first: 2 + 12)
console.log((2 + 3) * 4)   // 20  (parentheses first: 5 * 4)
```
...
console.log(0 == "")     // true    (both become "falsy/empty"…)
console.log(null == undefined) // true  (special case of ==)
```
...
console.log(!abonne)               // NOT: inverts the boolean → false
```
...
// 1) Round for display
const total = 0.1 + 0.2
console.log(total.toFixed(2))   // "0.30"  (string, rounded to 2 decimals)

// 2) Or work in cents (integers): 10 + 20 = 30 cents
```
