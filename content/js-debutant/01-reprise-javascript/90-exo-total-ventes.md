...
exercise:
  language: js
  starter: |
    // You are given three sale amounts (in euros).
    // Write a function that returns their TOTAL.
    function totalVentes(v1, v2, v3) {
      // TODO: add the three amounts and return the sum
      return null
    }

    // Write a function that returns the AVERAGE of the three sales.
    // Hint: reuse totalVentes, then divide by 3.
    function moyenneVentes(v1, v2, v3) {
      // TODO: compute the average of the three amounts
      return null
    }

    // (Optional) try your functions — output appears in "Sortie (console)":
